...
fun DashboardArtistsContent(
    ...
    when (val state = model.state.value) {
        ...
        is LoadSongsState.Loaded -> {
            val artists = state.music.artists
            ...
            if (artists.isEmpty()) {
                Box(
                    ...
                    Column(
                        ...
                        Text(stringResource(R.string.noArtistsFound))
                ...
                ArtistsLazyColumn(
                    ...
                    navigate = { navigationViewModel.navigateToArtist(it.artist.artistName) }
                )
            }
        }
